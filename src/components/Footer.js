        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#feature">
                  Features
                </a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="#integrations">
                  Integrations
                </a>
              </li>
              <li>
              ...
              <li>
                <a rel="noopener noreferrer" href="#fag">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#policy">
                  Privacy
                </a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="#term">
                  Terms of Service
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li>
                <a
                  rel="noopener noreferrer"
                  href="https://travelin-server.vercel.app"
                >
                  Public API
                </a>
              </li>
